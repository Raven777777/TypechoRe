...
class WebAuthn {
    ...
    public function __construct($rpName, $rpId, $allowedFormats=null, $useBase64UrlEncoding=false) {
        ...
        // TypechoRe accepts privacy-preserving self-attestation only. This keeps the
        // embedded Passkey implementation small and avoids shipping certificate
        // validation code that the single-admin blog does not use.
